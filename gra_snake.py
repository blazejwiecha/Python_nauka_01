    ...
    class Snake:  # snake class
        ...
        def __init__(self, width, height):
            ...
            self.msnake = [[self.width / 2, self.height / 2], [self.width / 2 + 1, self.height / 2],
                           [self.width / 2 + 2, self.height / 2]]  # snake elements
        ...
        def eat(self):  # snake must eat
            ...
            if self.msnake[0][0] == self.food[0] and self.msnake[0][1] == self.food[
                1]:  # if head of snake is on food, then snake eat
        ...
        def colision(self):
            ...
            if self.msnake[0][0] == 0 or self.msnake[0][1] == 0 or self.msnake[0][0] == self.width - 1 or \
                    self.msnake[0][1] == self.height - 1:
                self.col = True
